import 'package:POSApp/02User/UserListPage.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import '../config/theme.dart'; // Import your existing ThemeConfig
import '../01Group/GroupListPage.dart'; // Import your real GroupListPage
...
class _MenuSettingsPageState extends State<MenuSettingsPage> {
        ...
        child: GridView.count(
          ...
          children: [
            ...
            _buildGridItem(
              ...
              title: 'Merchant',
              color: Colors.green,
              onTap: () => _navigateToPage('Merchant Settings'),
            ),
            _buildGridItem(
              icon: Icons.storefront,
              title: 'Store',
              color: Colors.orange,
              onTap: () => _navigateToPage('Store Settings'),
            ),
            _buildGridItem(
              icon: Icons.computer,
              title: 'Terminal',
              color: Colors.purple,
              onTap: () => _navigateToPage('Terminal Settings'),
            ),
            // NEW: User menu item
            _buildGridItem(
              icon: Icons.person,
  ...
  void _navigateToPage(String pageName) {
    _showSnackBar('Navigating to $pageName');
    // TODO: Implement navigation to other specific settings pages
    // Navigator.push(context, MaterialPageRoute(builder: (context) => SpecificSettingsPage()));
  }
